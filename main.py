...
def get_token():
    apiKey = "8ihFNDsk6G8n0HjYPmlG1n0e"
    secretKey = "a40c7c1fbf433b0ae6843a41ef1c3881"
...
while(True):
    ...
    print str(a)
    url = "http://tsn.baidu.com/text2audio?tex="+dic_json['text']+"&lan=zh&per=0&pit=1&spd=7&cuid=9544385&ctp=1&tok=24.ce8a22d7af5405064c884f0c3ee1d4fe.2592000.1496927153.282335-9544385"
